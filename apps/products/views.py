...
from apps.products.models import Product, ProductComment, FavouriteProduct, LikeProduct
...
def favourite_product(request):
    products = FavouriteProduct.objects.all()
    context = {
        'products' : products,
    }
    return render(request, 'products/favourite.html', context)
